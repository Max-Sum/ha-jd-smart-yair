...
def _updated_auth_data(data: dict, new_tgt: str, new_cookie: str) -> dict:
    """Return config data with refreshed auth values."""
    updated = {**data, CONF_TGT: new_tgt}
    if data.get(CONF_COOKIE):
        updated[CONF_COOKIE] = new_cookie
    else:
