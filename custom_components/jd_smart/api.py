...
def _feed_id_value(feed_id: str) -> str | int:
    """Return feed_id using the JSON type sent by the Android app."""
    return int(feed_id) if feed_id.isdecimal() else feed_id
...
class JdSmartClient:
    ...
    async def async_get_snapshot(
        ...
        inner: dict[str, str | int] = {
            "feed_id": _feed_id_value(feed_id),
            "version": "2.0",
            "digest": digest,
        }
